...
class GlobalSettings {
    ...
    class func isCalenarAccessable() -> Bool{
        
        let value = GlobalVariables.globalUserDefaults.boolForKey(GlobalVariables.user_defaults_calendar_access)
        
        return value
    }
    class func setCalendarAccessable(value: Bool){
        
        GlobalVariables.globalUserDefaults.setBool(value, forKey: GlobalVariables.user_defaults_calendar_access)
