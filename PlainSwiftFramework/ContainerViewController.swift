...
class ContainerViewController: UIViewController {
    ...
    func addDetailsViewContoller(viewControllerEnumValue:Int){
        ...
        case DetailsViewControllerEnum.FirstViewController.rawValue:
            ...
            let detailViewController:NotesTableViewController = UIStoryboard.notesTableViewController()!
...
private extension UIStoryboard{
    ...
    class func notesTableViewController() -> NotesTableViewController? {
        
        return mainStoryboard().instantiateViewControllerWithIdentifier("NotesTableViewController") as? NotesTableViewController
